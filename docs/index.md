...
!!! important "Limites e disponibilidade"
    A API web não tem nenhuma [garantia de nível de serviço](https://pt.wikipedia.org/wiki/Acordo_de_n%C3%ADvel_de_servi%C3%A7o) e a única forma de aumentar sua disponibilidade e diminuir o tempo de resposta é com [contribuições mensais](https://apoia.se/minhareceita) ou contribuições pontuais via Pix (`d6ede813-6621-4df4-9a93-8d0108fd9b6a`) ou Bitcoin (`13WCAR21g1LGqzzn6WTNV5g7QdN1J35BDk`).
...
Para conversar sobre o projeto, prefira [abrir uma _issue_ no Codeberg](https://codeberg.org/cuducos/minha-receita/issues/new) ou iniciar uma conversa pública [Mastodon](https://tech.lgbt/@cuducos) ou [Bluesky](https://bsky.app/profile/cuducos.me). **Não responderei** mensagens deixadas como _DM_ ou emails em minhas contas pessoais:
